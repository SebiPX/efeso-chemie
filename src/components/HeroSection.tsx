      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-0 flex flex-col justify-center">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-6 lg:gap-10 mb-4 md:mb-6 pt-0">
          ...
          <div className="flex flex-col items-start w-full md:w-[60%]">
            <div className="grid grid-cols-1 md:grid-cols-[max-content_1fr] w-full">
              ...
              <div className="col-span-1 md:hidden flex justify-center mb-8">
                 <a href={language === 'de' ? "https://www.roi.de/unternehmensberatung/referenzen/beratung-chemie" : "https://www.roi-international.com/management-consulting/references/chemicals"} target="_blank" rel="noreferrer" className="block max-w-[260px] sm:max-w-[300px]">
                   <img 
          ...
          <div className="hidden md:flex w-full md:w-[45%] justify-end shrink-0">
             <a href={language === 'de' ? "https://www.roi.de/unternehmensberatung/referenzen/beratung-chemie" : "https://www.roi-international.com/management-consulting/references/chemicals"} target="_blank" rel="noreferrer" className="block md:max-w-[380px] lg:max-w-[480px]">
               <img 
                 src="/image/wuerfel-efeso-new.png" 
                 alt="Efeso Ice Cube" 
