...
export const translations = {
  ...
  about: {
    ...
    p4: {
      ...
      en: 'EFESO\'s work is regularly recognized for the high quality of its results and efficiency, as well the ability to deliver innovation, consistently reflected in high major industry rankings. Since 2013, EFESO has been awarding the best practical solutions in industrial digitalization with the INDUSTRIE 4.0 AWARD, which is one of the most prestigious international industry awards.'
    },
